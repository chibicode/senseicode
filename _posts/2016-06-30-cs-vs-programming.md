...
さきほどの「線引き」問題の例を出すとよく、「プログラミング思考とは数学なのか」と思われます。しかし、「コンピューターが問題を解きやすいように、人間が知恵を絞ること」は数学だけにとどまりません。
...
さらに補足すると、[前回の記事](/1-introduction)ではプログラミング言語「Ruby」開発者の[まつもとゆきひろ氏のプログラミング教育についての発言](https://twitter.com/yukihiro_matz/status/725206942868606977?ref_src=twsrc%5Etfw)を引用しましたが、当初Rubyの人気が出た理由のひとつは、「Rubyのコードは他人が読んでも理解しやすいから」でした。
