...
>
> 「**コンピューターが問題を解きやすいように、問題の正しい見方をすること**」を、**Computational Thinking(計算論的思考)**と呼ぶ。
>
> これは我が大学の[ジャネット・ウイング](https://www.cs.cmu.edu/afs/cs/usr/wing/www/ct-japanese.pdf)(元カーネギーメロン大コンピューターサイエンス学部長、現マイクロソフトリサーチ副社長)が提唱した概念だ。きみたちにはこれから4年間、みっちりComputational Thinkingを学んでもらう。

この「Computational Thinking」は文科省の用語「プログラミング思考」と置き換えて問題ありません。
